...
def hypercube_monte_carlo_random(num_points = 10, N = 7, num_ants = 10, fn = run_ants_on_hypercube_random_colors, mode = 'dynamic'):
    iter_list = []
    path_len_list = []
    ant_winner_list = []
    n_matchings_list = []
    for iter in range(num_points):
        (ant_winner, path_len), iter,  n_matchings = fn(N, num_ants, False, True, mode)
...
def hypercube_monte_carlo_optimised(num_points = 10, N = 7, num_ants = 10, fn = run_ants_on_hypercube_random_colors_optimized, mode = 'dynamic'):
    iter_list = []
    path_len_list = []
    ant_winner_list = []
    n_matchings_list = []
